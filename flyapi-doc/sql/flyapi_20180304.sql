...
CREATE TABLE `cms_rss` (
  `rss_id` bigint(11) NOT NULL COMMENT '主键',
  `user_id` bigint(11) NOT NULL COMMENT '订阅者',
  `subject_id` bigint(11) NOT NULL COMMENT '专题id',
...
-- ----------------------------
--  Table structure for `ucenter_social`
-- ----------------------------
DROP TABLE IF EXISTS `ucenter_social`;
CREATE TABLE `ucenter_social` (
  `social_id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `social_type` tinyint(4) NOT NULL COMMENT '1 github 2 知乎 3 微博 4 领英 5 开源中国 6 掘金 7 sf ',
